...
class QuestionFlagment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btn_next.setOnClickListener {
            ...
            if(isAllAnswered) {
                ...
                (activity as? TestActivity)?.questionairResults?.addResponses(responses)
    ...
    companion object {
        ...
        fun newInstance(questionType: Int) : QuestionFlagment {
            val fragment = QuestionFlagment()
            val args = Bundle()
